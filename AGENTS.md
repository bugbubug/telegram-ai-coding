...
8. 修改公共接口、Bot 命令、仓库选择流程或 workspace 生命周期后，同时更新 `README.md`、`CLAUDE.md`、`AGENTS.md` 与相关 `.claude/*.md`
...
- `/task`、`/codex`、`/claude` 和自由文本默认作用于当前已选仓库
...
- 内置：`/start`、`/repos`、`/task`、`/status`、`/logs`、`/cancel`、`/clear`、`/reset`
- 插件：`/codex`、`/claude`
